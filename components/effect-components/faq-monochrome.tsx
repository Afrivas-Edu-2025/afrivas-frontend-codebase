...
const palettes = {
  dark: {
    ...
    iconRing: "border-primary/50",
    iconSurface: "bg-primary/10",
    icon: "text-primary",
    toggle: "border-primary/40 text-primary",
    toggleSurface: "bg-primary/15",
    glow: "hsl(var(--primary) / 0.10)",
    aurora: "radial-gradient(ellipse 50% 100% at 10% 0%, hsl(var(--secondary) / 0.15), transparent 65%)",
    shadow: "shadow-[0_36px_140px_-60px_rgba(10,10,10,0.65)]",
    overlay: "linear-gradient(130deg, hsl(var(--primary) / 0.08) 0%, transparent 65%)",
  },
  light: {
    surface: "bg-background text-foreground",
    panel: "bg-secondary/40",
    border: "border-secondary",
    heading: "text-foreground",
    muted: "text-muted-foreground",
    iconRing: "border-secondary",
    iconSurface: "bg-secondary/10",
    icon: "text-secondary",
    toggle: "border-secondary text-secondary",
    toggleSurface: "bg-secondary/20",
    glow: "hsl(var(--secondary) / 0.10)",
    aurora: "radial-gradient(ellipse 50% 100% at 10% 0%, hsl(var(--secondary) / 0.10), rgba(255, 255, 255, 0.92) 70%)",
    shadow: "shadow-[0_36px_120px_-70px_rgba(15,15,15,0.18)]",
    overlay: "linear-gradient(130deg, hsl(var(--secondary) / 0.08) 0%, transparent 70%)",
  },
};
...
function FAQ1() {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      .faq1-intro--light {
        ...
        background: hsl(var(--secondary) / 0.90);
      ...
      .faq1-intro__beam {
        background: conic-gradient(from 160deg, hsl(var(--secondary) / 0.25), transparent 32%, hsl(var(--secondary) / 0.22) 58%, transparent 78%, hsl(var(--secondary) / 0.18));
        animation: faq1-beam-spin 18s linear infinite;
        opacity: 0.55;
      }
      .faq1-intro--light .faq1-intro__beam {
        background: conic-gradient(from 180deg, hsl(var(--primary) / 0.18), transparent 30%, hsl(var(--primary) / 0.18) 58%, transparent 80%, hsl(var(--primary) / 0.14));
      }
      .faq1-intro__pulse {
      ...
      .faq1-intro--light .faq1-intro__tick {
        box-shadow: 0 0 0 4px hsl(var(--secondary) / 0.10);
      }
      .faq1-fade {
        opacity: 0;
  ...
  return (
    <div className={`relative min-h-screen w-full overflow-hidden transition-colors duration-700 ${palette.surface}`}>
      <div className="absolute inset-0 z-0 rounded-lg" style={{ background: palette.aurora }} />
      <div
        className="pointer-events-none absolute inset-0 z-0 opacity-80  rounded-lg"
        style={{ background: palette.overlay, mixBlendMode: theme === "dark" ? "screen" : "multiply" }}
      />

      <section
        className={`relative z-10 mx-auto flex max-w-4xl flex-col gap-12 px-6 py-24 lg:max-w-5xl lg:px-12  rounded-lg ${
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  style={{ "--faq-outline": theme === "dark" ? "hsl(var(--primary) / 0.35)" : "hsl(var(--secondary) / 0.35)" }}
