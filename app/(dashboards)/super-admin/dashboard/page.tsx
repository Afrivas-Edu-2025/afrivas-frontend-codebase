    ...
    return (
        <div className="space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Platform-wide overview and university management</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Active platform control</p>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    ...
                    <CardContent>
                        <div className="text-2xl font-bold">Optimum</div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <Card className="col-span-1">
                    ...
                    <CardContent>
                        <p className="text-sm text-muted-foreground text-center py-8">No universities registered yet.</p>
                    </CardContent>
                </Card>
                <Card className="col-span-1">
                    <CardHeader>
